! function() {
    ...
    function a(e) {
        ...
        })), "onfocusin" in document && (document.onfocusin = n, document.onfocusout = o), window.onpageshow = window.onfocus = n, window.onpagehide = window.onblur = o
    }
    ...
    function s() {
        var e = (navigator.cookieEnabled ? "cT" : "cF") + "|" + (navigator.deviceMemory ? "dm" + navigator.deviceMemory : "dm") + "|" + (navigator.hardwareConcurrency ? "hc" + navigator.hardwareConcurrency : "hc") + "|" + (navigator.languages ? "l" + navigator.languages.join(",") : "l") + "|";
        if (navigator.platform || navigator.appName ? e += (navigator.platform ? "p" + navigator.platform : "p") + "|" + (navigator.vendor ? "v" + navigator.vendor : "v") + "|" + (navigator.appCodeName ? "a" + navigator.appCodeName : "a") + "|" + (navigator.appName ? "n" + navigator.appName : "n") + "|" : e += (navigator.userAgent ? "ua" + navigator.userAgent : "ua") + "|", navigator.plugins) {
            var t, n, o = "";
            for (n = navigator.plugins.length > 20 ? 20 : navigator.plugins.length, t = 0; t < n; t++) navigator.plugins[t] && navigator.plugins[t].filename ? o += navigator.plugins[t].filename : navigator.plugins[t] && navigator.plugins[t].name && (o += navigator.plugins[t].name);
            e += "pl" + o + "|"
        }
        return e += "pr" + window.devicePixelRatio + "|", e += "w" + (screen && screen.width ? screen.width : window.innerWidth) + "h" + (screen && screen.height ? screen.height : window.innerHeight) + "|", e += "cD" + (screen.colorDepth ? screen.colorDepth : "") + "|", e += "tO" + (new Date).getTimezoneOffset() + "|", e = c(e += "mT" + (void 0 !== navigator.maxTouchPoints ? navigator.maxTouchPoints : void 0 !== navigator.msMaxTouchPoints ? navigator.msMaxTouchPoints : "") + "|")
    }
    ...
    function g(t) {
        ...
        var n;
        l(), u(), m.page = d(), m.referrer = document.referrer || "", m.userid = x, m.sessionid = E, m.user_agent = window.navigator.userAgent, m.user_language = window.navigator.userLanguage || window.navigator.language, e && (m.projectid = e.getAttribute("data-tilda-project-id") || "0", m.pageid = e.getAttribute("data-tilda-page-id") || "0", m.pagealias = e.getAttribute("data-tilda-page-alias") || "", m.formskey = e.getAttribute("data-tilda-formskey") || ""), m.params = {};
        try {
        ...
        var r = !1;
        if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && (r = !0), m.ismobile = r, document.getElementById("tildastatscript") && (m.tildastatcode = document.getElementById("tildastatscript").key), k) try {
            a((function(e) {
                v = !!e
    ...
    function p(e) {
        ...
        "" === m.referrer && (m.referrer = n("previousUrl") || ""), m.tildautm = n("TILDAUTM") || "", m.page || (console.log("TildaStat: page empty"), m.page = d(), window.location.hash && 0 === window.location.hash.indexOf("#!") && (m.page += window.location.hash)), "/" === m.page.substring(0, 1) && (m.page = window.location.hostname + m.page);
        var a = f(m),
            r = new XMLHttpRequest;
        r.open("POST", t, !0), r.withCredentials = !1, r.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"), r.onerror = function(e) {
            console.error("TildaStat: fail pageview "), console.error(e)
        }, r.timeout = 3e3, r.send(a), m.page && -1 === m.page.indexOf("tilda/scroll") && -1 === m.page.indexOf("tilda/readtime") && -1 === m.page.indexOf("tilda/click") && -1 === m.page.indexOf("tilda/cookieenabled") && (m.referrer = m.page, h || o("previousUrl", m.page, {
            path: "/",
            expires: 1800
    ...
    var j = setInterval((function() {
            if (("object" == typeof window.t_jserrors && window.t_jserrors.length > 0 || "object" == typeof window.t_cdnerrors && window.t_cdnerrors.length > 0 || "object" == typeof window.t_ajaxerrors && window.t_ajaxerrors.length > 0) && "function" != typeof t_errors__sendJSErrors) {
                var e = document.createElement("script");
                e.src = "https://static.tildacdn." + L() + "/js/tilda-errors-1.0.min.js", e.async = !0, document.body.appendChild(e), clearInterval(j)
            }
        }), 2e3),
    ...
    var A = O ? O.getAttribute("href") : "",
        ...
        I;
    (C || (C = O && -1 !== A.indexOf("static.tildacdn." + L()) && -1 !== A.indexOf("tilda.") && -1 !== A.indexOf("/tildafavicon.ico") && !document.querySelector("table#allrecords") && !(-1 !== window.location.hostname.indexOf(".tilda.ws")) && !_), void 0 === navigator.sendBeacon || /Bot/i.test(navigator.userAgent) || C) || 1 === Math.floor(5 * Math.random()) && S((function() {
        var e = document.createElement("script");
        e.async = !0, e.type = "text/javascript", e.src = "https://static.tildacdn." + L() + "/js/tilda-performance-1.0.min.js", document.body.insertAdjacentElement("beforeend", e)
    }));
