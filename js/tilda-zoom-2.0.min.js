...
function t_initZoom() {
    ...
    if (!document.querySelector(".t-zoomer__wrapper")) {
        ...
        r.appendChild(n), r.appendChild(a), r.appendChild(i), r.appendChild(l), document.body && document.body.insertAdjacentElement("beforeend", r), t_zoom__initFullScreenImgOnClick(), t_zoom__closeAndSlideCarousel()
    }
}
...
function t_zoomHandler(t) {
    var e;
    document.body.classList.add("t-zoomer__show"), document.querySelector(".t-popup_show") && document.body.classList.add("t-zoomer__active");
    ...
    n.appendChild(l), n.appendChild(c), n.appendChild(a), r.appendChild(n), o && (o.innerHTML = ""), o && o.appendChild(r);
    var s = t.closest(".r"),
        _;
    ...
    return d && (d.style.display = "flex"), t_zoom_setModalColor(s), t_zoom__createAndLoopSlider(t), t_zoom__getEventOnBtn(), document.body.classList.add("t-zoomer__show_fixed"), t_zoom__initSingleZoom(), t_zoom_checkForScale(), t_zoom_lockScroll(), window.t_zoom__isMobile ? (t_zoom_initSwipe(), t_zoom_initCloseSwipe(), window.addEventListener("orientationchange", t_zoom__updateActiveSlidePos)) : window.addEventListener("resize", t_zoom__updateActiveSlidePos), window.tzoomopenonce = !0, t_zoom__initEventsonMobile(), !0
}
...
function t_zoom_createSliderArrow(t) {
    ...
    e.classList.add("t-carousel__zoomer__control"), e.classList.add("t-carousel__zoomer__control_" + t), e.setAttribute("data-zoomer-slide", "left" === t ? "prev" : "next");
    var o = document.createElement("div");
    o.classList.add("t-carousel__zoomer__arrow__wrapper"), o.classList.add("t-carousel__zoomer__arrow__wrapper_" + t);
    var r = document.createElement("div");
    return r.classList.add("t-carousel__zoomer__arrow"), r.classList.add("t-carousel__zoomer__arrow_" + t), r.classList.add("t-carousel__zoomer__arrow_small"), o.appendChild(r), e.appendChild(o), e
}
...
function t_zoom_initSwipe() {
    ...
    if (t.length > 1) {
        ...
        window.tzoomopenonce || (o.on("panstart", (function() {
            var t = document.querySelector(".t-carousel__zoomer__track"),
                o;
            "y" !== t.getAttribute("data-on-transition") ? t && (r = t.getBoundingClientRect().left, t.style.transition = "none") : r = null, n = t_zoom__isScaled(e)
            ...
            var o = document.querySelector(".t-carousel__zoomer__track"),
                ...
                l;
            if ("y" !== a && "y" !== i && 1 === t.maxPointers && !n && (Math.abs(t.deltaX) > 40 && o.setAttribute("data-on-drag", "y"), r)) {
                var c = r + t.deltaX;
            ...
            if ("y" !== a && "y" !== i && 1 === o.maxPointers && !n) {
                ...
                m > .6 ? m = .6 : m < .2 && (m = .2), r.style.transitionDuration = m + "s", o.velocityX < -.5 || o.deltaX < -80 ? (t_zoom_unscale(), t_zoom_showSlide("next"), t_zoom_checkForScale()) : o.velocityX > .5 || o.deltaX > 80 ? (t_zoom_unscale(), t_zoom_showSlide("prev"), t_zoom_checkForScale()) : t_zoom_showSlide()
            }
        })))
    }
}
...
function t_zoom__addingImgsIntoCarousel(t) {
    ...
    if (e ? e.querySelector(".t-slds") : null) {
        ...
        n && (o = n.querySelectorAll(".t-zoomable:not(.t-slds__thumbs_gallery)")), n && n.querySelector(".tn-elem__gallery__video-wrapper") && (o = Array.prototype.slice.call(o)).splice(-1, 1)
    }
    ...
    Array.prototype.forEach.call(o, (function(t, e) {
        var r = t.getAttribute("data-img-zoom-url"),
            ...
            s = r ? r.split(",") : "",
            _, d;
        "IMG" !== t.nodeName && "DIV" !== t.nodeName || (n = t.getAttribute("title") || "", c = t.getAttribute("data-img-zoom-descr") || ""), n && ((_ = document.createElement("div")).classList.add("t-zoomer__title"), _.classList.add("t-descr"), _.classList.add("t-descr_xxs"), _.textContent = n, a && a.titleFontFamily && (_.style.fontFamily = a.titleFontFamily)), c && ((d = document.createElement("div")).classList.add("t-zoomer__descr"), d.classList.add("t-descr"), d.classList.add("t-descr_xxs"), d.textContent = c, a && a.descrFontFamily && (d.style.fontFamily = a.descrFontFamily));
        var m = document.createElement("div");
        m.classList.add("t-carousel__zoomer__item");
        var u = document.createElement("div");
        u.classList.add("t-carousel__zoomer__wrapper");
        var f = document.createElement("img");
        if (f.classList.add("t-carousel__zoomer__img"), l ? (f.classList.add("t-img"), f.setAttribute("data-original", s), 0 !== e && e !== o.length - 1 || f.setAttribute("data-lazy-rule", "skip")) : f.src = s, m.appendChild(u), u.appendChild(f), n || c || window.t_zoom__isMobile) {
...
function t_zoom__getZoomDescriptionFontFamily(t) {
    var e = t.querySelector('.t827__overlay-title, .t979__overlay-title, .t-slds__title, .t603__title, [itemprop="name"]'),
        o = t.querySelector('.t827__overlay-descr, .t979__overlay-descr, .t-slds__descr, .t603__descr, [itemprop="description"]'),
        r, n;
    return {
...
function t_zoom__createAndLoopSlider(t) {
    ...
    if (o && r.length) {
        ...
        if (d) {
            ...
            d.classList.add("active"), t_zoom__hideInnactiveSlides(d, e), e.style.transition = "none", e.style.transform = "translateX(" + -m + "px)", setTimeout((function() {
                e.style.transition = ""
            }), 200)
        }
...
function t_zoom_showSlide(t) {
    ...
    if (Array.prototype.forEach.call(o, (function(t, e) {
        ...
        n = i % o.length, e.setAttribute("data-on-transition", "y"), window.t_zoom__isMobile && "0s" === getComputedStyle(e).transitionDuration && !a && (e.style.transition = "")
    }
    var l = o[n],
        c = l.offsetLeft;
    if (r.classList.remove("active"), l.classList.add("active"), e.style.transform = "translateX(" + -c + "px)", t_zoom__hideInnactiveSlides(l, e), a) {
...
function t_zoom_transitForLoop(t) {
    var e = document.querySelector(".t-carousel__zoomer__track"),
        ...
        r, n;
    t && ("start" === t && (r = o.length - 2), "end" === t && (r = 1), n = o[r].offsetLeft, Array.prototype.forEach.call(o, (function(t, e) {
...
function t_zoom_loopSlider() {
    ...
    o.classList.remove("active"), r.classList.remove("active"), t_zoom__updateClonedImgSrc(e[0], e[e.length - 1], o, r), t.insertBefore(r, t.firstChild), t.appendChild(o);
    ...
    ["transitionend", "webkitTransitionEnd", "oTransitionEnd"].forEach((function(o) {
        t.addEventListener(o, (function() {
            ...
            })), 0 === o && t_zoom_transitForLoop("start"), o === n - 1 && t_zoom_transitForLoop("end"), t.setAttribute("data-on-transition", "")
        }))
    }))
}
        ...
        if (!c.some((function(t) {
            ...
            var s = new MutationObserver((function(t) {
                t.forEach((function(t) {
                    var e;
                    "attributes" === t.type && "src" === t.attributeName && (t.target === n && (e = i), t.target === a && (e = l), t.target === i && (e = n), t.target === l && (e = a), t.target.src && !e.src && (e.src = t.target.src))
                }))
            }));
...
function t_zoom_initCloseSwipe() {
    ...
    n.on("panstart", (function() {
        ...
        if (("y" !== e.getAttribute("data-on-drag") || "y" === t.getAttribute("data-on-drag")) && (n.angle > -120 && n.angle < -60 || n.angle < 120 && n.angle > 60) && 1 === n.maxPointers && !o) {
...
function t_zoom_closeSwipeHandler(t) {
    ...
    e.style.transition = "transform 300ms ease-out", Math.abs(t.deltaY) < 40 && (e.style.transform = ""), "y" !== e.getAttribute("data-on-drag") || 1 !== t.maxPointers || r || (t.deltaY < -200 || t.velocityY < -.3 ? (e.style.transform = "translateY(-100vh)", setTimeout((function() {
        t_zoom_close(), e.style.transform = ""
    }), o)) : t.deltaY > 200 || t.velocityY > .3 ? (e.style.transform = "translateY(100vh)", setTimeout((function() {
        t_zoom_close(), e.style.transform = ""
...
function t_zoom_checkToScaleInit(t) {
    ...
    var n = t.hasAttribute("data-original-svg-height") || t.hasAttribute("data-original-svg-width"),
        ...
        i = parseInt(t.getAttribute("data-original-svg-width"), 10) || t.naturalWidth; - 1 === t.src.indexOf(".svg") || window.isIE || n ? o < a || e < i ? (!window.isDoubletapScaleAdded && window.t_zoom__isMobile && t_zoom_doubletapScaleInit(), t_zoom_scale_init()) : (document.querySelector(".t-zoomer__scale").style.display = "", r.classList.add("zoomer-no-scale")) : t_zoom_fetchSVG(t, o, e)
}
...
function t_zoom_fetchSVG(t, e, o) {
    ...
    fetch(r).then((function(t) {
        ...
        var a = n.querySelector("svg"),
            ...
            c = i / l,
            s = 5e3;
        i > s && (i = s, l = Math.round(i / c)), t.setAttribute("data-original-svg-width", i), t.setAttribute("data-original-svg-height", l), e < l || o < i ? (t.style.width = i + "px", t.style.height = l + "px", !window.isDoubletapScaleAdded && window.t_zoom__isMobile && t_zoom_doubletapScaleInit(), t_zoom_scale_init()) : document.querySelector(".t-zoomer__scale").style.display = "", document.body.removeChild(n)
    }))
}
...
function t_zoom_scale_init() {
    ...
    e.style.display = "block", "y" !== e.getAttribute("data-zoom-scale-init") && (e.setAttribute("data-zoom-scale-init", "y"), t.addEventListener("click", (function(e) {
...
function t_zoom_doubletapScaleInit() {
    ...
    new Hammer(t, {
        ...
        if (2 === e.tapCount && document.body.classList.contains("t-zoomer__show") && !e.target.closest(".t-carousel__zoomer__control")) {
            var o = document.querySelector(".t-carousel__zoomer__item.active .t-carousel__zoomer__img"),
                r = document.querySelector(".t-carousel__zoomer__inner"),
                n = document.querySelector(".t-carousel__zoomer__track");
            o.style.maxHeight = "", n.style.transition = "none", n.style.transform = "none", t.classList.contains("scale-active") ? t_zoom_unscale() : (t.classList.add("scale-active"), r.classList.add("scale-active"), t_zoom_mobileZoomPositioningInit(o))
        }
    }))
}
...
function t_zoom_desktopZoomPositioningInit(t, e) {
    ...
    function _(t, e) {
        i = 100 * (void 0 !== t.touches ? t.touches[0].clientX : t.clientX) / window.innerWidth, l = -i * (e.offsetWidth - window.innerWidth) / 100, e.style.left = l + "px"
    }

    function d(t, e) {
        n = 100 * (void 0 !== t.touches ? t.touches[0].clientY : t.clientY) / window.innerHeight, a = -n * (e.offsetHeight - window.innerHeight) / 100, e.style.top = a + "px"
    }
    t.style.left = o + "px", t.style.top = r + "px", window.innerWidth < c && window.innerHeight < s ? (i = 100 * e.clientX / window.innerWidth, l = -i * (c - window.innerWidth) / 100, n = 100 * e.clientY / window.innerHeight, a = -n * (s - window.innerHeight) / 100, t.style.left = l + "px", t.style.top = a + "px", window.t_zoom__isMobile ? t.ontouchmove = function(e) {
        _(e, t), d(e, t)
    } : t.onmousemove = function(e) {
        _(e, t), d(e, t)
    }) : window.innerWidth < c ? (i = 100 * e.clientX / window.innerWidth, l = -i * (c - window.innerWidth) / 100, t.style.left = l + "px", window.t_zoom__isMobile ? t.ontouchmove = function(e) {
        _(e, t)
    } : t.onmousemove = function(e) {
        _(e, t)
    }) : window.innerHeight < s && (n = 100 * e.clientY / window.innerHeight, a = -n * (s - window.innerHeight) / 100, t.style.top = a + "px", window.t_zoom__isMobile ? t.ontouchmove = function(e) {
        d(e, t)
    } : t.onmousemove = function(e) {
        d(e, t)
    })
...
function t_zoom_mobileZoomPositioningInit(t) {
    ...
    t.ontouchstart = function(t) {
        ...
        var l = t_zoom_getTouchEventXY(i),
            ...
            s = (l.x - n.x) * c,
            _ = (l.y - n.y) * c;
        a.x = r.x + s, a.y = r.y + _, a.x > -e && (a.x = -e), a.x < e && (a.x = e), a.y > -o && (a.y = -o), a.y < o && (a.y = o), t.offsetHeight < window.innerHeight && (a.y = 0), t.style.transform = "translate(" + a.x + "px, " + a.y + "px)"
...
function t_zoom_close() {
    t_zoom_unscale(), document.body.classList.remove("t-zoomer__show"), document.body.classList.remove("t-zoomer__show_fixed");
    ...
    }), 200), t_zoom_unlockScroll(), window.t_zoom__isMobile ? (window.removeEventListener("orientationchange", t_zoom__updateSlidesHeight), window.removeEventListener("orientationchange", t_zoom__updateActiveSlidePos)) : window.removeEventListener("resize", t_zoom__updateActiveSlidePos)
}
...
function t_zoom_unscale() {
    ...
    if (e) {
        ...
        if (r) {
            ...
            var c = i + l;
            n.onmousemove = null, n.ontouchmove = null, n.style.transform = "", n.style.left = "", n.style.top = "", n.style.maxHeight = document.documentElement.clientHeight - c + "px"
        }
    }
...
function t_zoom_lockScroll() {
    var t = /(android)/i.test(navigator.userAgent),
        e;
    if ((window.t_zoom__isiOS && 11 === window.t_zoom__iOSMajorVersion && !window.MSStream || t) && !document.body.classList.contains("t-body_scroll-locked")) {
        var o = window.pageYOffset;
        document.body.classList.add("t-body_scroll-locked"), document.body.style.top = "-" + o + "px", document.body.setAttribute("data-popup-scrolltop", o.toString())
    }
}
...
function t_zoom_unlockScroll() {
    ...
    if ((window.t_zoom__isiOS && 11 === window.t_zoom__iOSMajorVersion && !window.MSStream || t) && document.body.classList.contains("t-body_scroll-locked")) {
        ...
        document.body.classList.remove("t-body_scroll-locked"), document.body.style.top = "", document.body.removeAttribute("data-popup-scrolltop"), window.scrollTo(0, Number(o))
    }
}
...
function t_zoom_setModalColor(t) {
    var e = "#ffffff",
        ...
        n = r || e,
        a;
    n = -1 !== n.indexOf("-gradient(") ? t_zoom_getFirstColorFromGradient(n) : t_zoom_hexToRgb(n), document.getElementById("allrecords") !== document.querySelector(".t-store__product-snippet") && document.getElementById("allrecords").contains(document.querySelector(".t-store__product-snippet")) && t && (n = t.style.backgroundColor);
