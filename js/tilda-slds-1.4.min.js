...
function t_slds__createDummies(t, e, s) {
    ...
    if (!d && t && !s.querySelector('.t-slds__item[data-slide-index="' + (r + 1) + '"]')) {
        var m = t.cloneNode(!0);
        if (m.setAttribute("data-slide-index", r + 1), m.classList.remove("t-slds__item_active"), m.setAttribute("aria-hidden", "true"), e.insertAdjacentElement("afterend", m), e.classList.add("t-slds__item-loaded"), a > 0 && "true" === l)
...
function t_slds__hideMobileSlides(t) {
    if (t) {
        ...
        if (!s || "scroll" !== s.overflowX || "flex" !== s.display) {
            ...
            if (!(i.length <= 2 * r)) {
                for (var a = t.getAttribute("data-slide-index"), l = [a = parseInt(a, 10)], d = 1; d < r; d++) a + d <= i.length ? l.push(a + d) : l.push(d), a - d > 0 ? l.push(a - d) : l.push(i.length + 1 - d);
    ...
    if (i) {
        ...
        if (r) {
            var a = parseFloat(r.getAttribute("data-slider-pos")),
                l, d = (r.getAttribute("data-slider-items-in-row") || 0) > 0 ? i.querySelector(".t-slds__container .t-slds__item").offsetWidth : i.querySelector(".t-slds__container").offsetWidth,
    ...
    if (i) {
        ...
        if (r) {
            var a = i.querySelectorAll(".t-slds__item:not(.t-slds__item_dummy)"),
                ...
                n = d > 0 ? i.querySelector(".t-slds__container .t-slds__item").offsetWidth : i.querySelector(".t-slds__container").offsetWidth,
                        ...
                        if (1 != e) {
                            ...
                            window.removeEventListener("touchmove", m, {
                                ...
                                var s = r.querySelector(".t-slds__items-wrapper"),
                                    ...
                                    l = a > 1,
                                    d = l ? r.querySelector(".t-slds__container .t-slds__item").offsetWidth : r.querySelector(".t-slds__container").offsetWidth,
