...
function t_store_fixImgs() {
    var t, e;
    /Version\/16\.3/.test(navigator.userAgent) && /Safari/.test(navigator.userAgent) && ["754", "776", "778", "786", "1025"].forEach((function(t) {
...
function t_store_lazyInit(t, e) {
    ...
    if ("" !== e.storepart) {
        ...
        var v = function r() {
                p[t] && p[t].page && (l = Array.isArray(p[t].page) ? p[t].page.join("") : p[t].page), t_store_loadProducts("", t, e, l), t_store_mobileHoriz_checkBtnVisibility(t, e)
            },
            m = function o() {
            ...
            y = function e(r) {
                if (window.tStoreFilters || (window.tStoreFilters = {}), r && (r.filters && r.filters.length > 0 || r.search || r.sort)) {
                    window.tStoreFilters[t] = r;
                    var o = t_store__getRootZone(),
                        i = "tilda-catalog-filters-1.0";
                    if (document.head.querySelector('script[src*="' + i + '"]')) t_store_onFuncLoad("t_store_filters_init", (function() {
                        m()
                    }));
                    else {
                        var s = document.createElement("script");
                        s.type = "text/javascript", s.src = "https://static.tildacdn." + o + "/js/" + i + ".min.js", s.onload = m, s.onerror = function() {
                            console.error("Failed to load tilda-catalog-filters: ", this.src), v()
                        }, document.head.appendChild(s)
                    }
                    if (!document.head.querySelector('link[href*="' + i + '"]')) {
                        var a = document.createElement("link");
                        a.rel = "stylesheet", a.type = "text/css", a.href = "https://static.tildacdn." + o + "/css/" + i + ".min.css", a.media = "all", document.head.appendChild(a)
                    }
                    t_store__loadJSFile("https://static.tildacdn." + o + "/js/tilda-tooltip-1.0.min.js"), t_store__loadCSSFile("https://static.tildacdn." + o + "/css/tooltipster.min.css")
                } else v()
            };
        ...
        if (e.tabs) {
            var h = "tilda-catalog-tabs-1.0",
                w, b;
            if (!document.head.querySelector('script[src*="' + h + '"]'))(w = document.createElement("script")).type = "text/javascript", w.src = "https://static.tildacdn." + t_store__getRootZone() + "/js/" + h + ".min.js", w.onerror = function() {
                console.error("Failed to load tilda-catalog-tabs: ", this.src)
            }, document.head.appendChild(w);
            if (!document.head.querySelector('link[href*="' + h + '"]'))(b = document.createElement("link")).rel = "stylesheet", b.type = "text/css", b.href = "https://static.tildacdn." + t_store__getRootZone() + "/css/" + h + ".min.css", b.media = "all", document.head.appendChild(b)
        }
        ...
        window.addEventListener("resize", t_throttle((function() {
            r && (e.prodCard && "1025" == e.prodCard.blockId ? t_store_unifyCardsWidth(t) : t_store_unifyCardsHeights(t, e), t_store_loadMoreBtn_display(t), (e.sidebar || Object.keys(e.filters || {}).length > 1) && t_store_moveSearhSort(t, e), e.showPagination && "on" === e.showPagination && t_store_onFuncLoad("t_store_pagination_display", (function() {
...
function t_store_snippet_initProduct(t, e, r) {
    ...
    if ("100" === e.popup_opts.popupContainer) {
        ...
        a.classList.add("t-container_fluid"), a.style.maxWidth = "100%", a.firstElementChild && a.firstElementChild.classList.add("t-container_fluid");
        var n = i.parentElement.querySelector(".t-store__relevants__container > .t-container");
        n && (n.classList.add("t-container_fluid"), n.style.maxWidth = "100%")
    }
    ...
    if (c) {
        var l = c.getAttribute("data-tilda-project-lang");
        l && (window.tStoreBrowserLang = l)
    }
    window.tStoreDict || t_store_getDictObj();
    var p = i.querySelector(".js-store-prod-sku");
    if (p && "none" !== p.style.display && p.insertAdjacentHTML("beforebegin", window.tStoreDict.sku + ": "), i.setAttribute("data-product-gen-uid", r.uid), i.setAttribute("data-product-part-uid", r.partuids ? r.partuids.join(",") : ""), e.tabs) {
        var _ = "tilda-catalog-tabs-1.0";
        if (document.head.querySelector('script[src*="' + _ + '"]')) t_onFuncLoad("t_store_tabs_initSnippet", (function() {
            t_store_tabs_initSnippet(t, e, i, r), d()
        }));
        else {
            var u = document.createElement("script");
            u.type = "text/javascript", u.src = "https://static.tildacdn." + t_store__getRootZone() + "/js/" + _ + ".min.js", u.onload = function() {
        ...
        if (!document.head.querySelector('link[href*="' + _ + '"]')) {
            var g = document.createElement("link");
            g.rel = "stylesheet", g.type = "text/css", g.href = "https://static.tildacdn." + t_store__getRootZone() + "/css/" + _ + ".min.css", g.media = "all", document.head.appendChild(g)
        }
    } else t_store_initTextAndCharacteristics(i, r), d();
    if (t_store_triggerEvent(document.body, "twishlist_addbtn"), !e.relevants_slider) {
        var v = o.querySelector(".t-store__relevants-grid-cont.t-store__grid-cont_mobile-one-row");
        if (v) {
            var m = t_store_get_handIcon_html(t, e.horizontalScrollHint);
            v.insertAdjacentHTML("beforebegin", m)
        }
    }
    e.popup_opts.fixedButton && t_store_fixedPopupButton(t), t_store_hoverZoom_init(t), t_store_get_productPopup_closeIcon_color(t, e), setTimeout((function() {
...
function t_store_verticalAlignButtons(t, e) {
    ...
    if (r) {
        ...
        if (i && Array.prototype.forEach.call(i, (function(t) {
                t.style.height = "unset", 1 === a ? t.style.height = "auto" : (_.push(t), t.offsetHeight > s && (s = t.offsetHeight), Array.prototype.forEach.call(_, (function(t) {
                    t.style.height = s + "px"
                })), p === a && (p = 0, s = 0, _ = []), p++)
            })), e.showRelevants) {
...
function t_store_hoverZoom_init(t) {
    var e = "https://static.tildacdn." + t_store__getRootZone() + "/js/tilda-hover-zoom-1.0.min.js",
        r;
    window.tStoreIsMobile || document.getElementById("rec" + t).querySelector("[data-hover-zoom]") && t_store__loadJSFile(e, (function() {
        t_hoverZoom_init(t)
    }))
}
...
function t_store_loadProducts(t, e, r, o, i) {
    ...
    if (c) {
        ...
        if (d && (_.getparts = !0, _.getoptions = !0), o && (_.slice = o), r.filters && (_.filters = r.filters, _.getparts = !0), r.sort && !s && (_.sort = r.sort), r.size && r.size > 0 && (_.size = r.size), r && r.defaultSort && r.defaultSort.in_stock && s && (_.filters || (_.filters = {}), _.filters.quantity = "y"), !window.t_store_endpoint) {
        ...
        if (!r.isPublishedPage) {
            ...
            _.projectid = document.getElementById("allrecords").getAttribute("data-tilda-project-id"), g = "https://" + m + "/projects/store" + (s ? "/getrelevantproducts/" : "/getproductslist/")
        }
        var y = Date.now();
        ...
        window.tStoreXHR[e] = f, f.onload = function() {
            if (f.readyState === f.DONE && 200 === f.status) {
                ...
                if (_.options && _.options.length >= 1 && (window.tStoreOptionsList = _.options), t_store_process(u, e, r, !!o, s, _), _.parts && _.parts.length > 1 && !c.querySelector(".js-store-parts-switcher") && !r.hideStoreParts) {
                    var g = function t() {
                    ...
                    if (document.head.querySelector('script[src*="' + v + '"]')) g();
                        ...
                        m.type = "text/javascript", m.src = "https://static.tildacdn." + t_store__getRootZone() + "/js/" + v + ".min.js", m.onload = g, m.onerror = function() {
                            console.error("Failed to load tilda-catalog-filters: ", this.src)
                        }, document.head.appendChild(m)
                    }
                    if (!document.head.querySelector('link[href*="' + v + '"]')) {
                        var y = document.createElement("link");
                        y.rel = "stylesheet", y.type = "text/css", y.href = "https://static.tildacdn." + t_store__getRootZone() + "/css/" + v + ".min.css", y.media = "all", document.head.appendChild(y)
                    }
                }
                window.tStoreFilters || (window.tStoreFilters = {});
                var t = window.tStoreFilters[e];
                if ("y" === _.filter && !r.hideFilters && t) t && (t.filters && t.filters.length > 0 || t.search || t.sort) && t_store_onFuncLoad("t_store_filters_init", (function() {
                    ...
                    if (w) {
                        ...
                        var b = "RU" === window.tStoreBrowserLang ? 'Пожалуйста, добавьте хотя бы один фильтр каталога для отображения боковой панели магазина. <a href="https://help-ru.tilda.cc/online-store-payments/filters" target="_blank" rel="nofollow noopener">Справка</a>' : 'Please <a href="https://help.tilda.cc/online-store-payments/filters" target="_blank" rel="nofollow noopener">add at least one catalog filter</a> to display the store sidebar';
                ...
                var C = t_throttle((function() {
                        if (!window.tStoreProductsRequested && window.innerWidth < 960) {
                            var t = l.scrollWidth,
                                e = l.scrollLeft,
                                r;
                            l.offsetWidth + e + 20 > t && "none" !== x.style.display && (x.click(), l.removeEventListener("scroll", C))
                        }
                    })),
                ...
                if (_.nextslice) {
                    if (!x) {
                        var j;
                        if (x = t_store_get_loadMoreBtn_html(c, r), r.sidebar) c.querySelector(".t951__cont-w-filter .t951__cont-wrapper + .t-store__pagination") || c.querySelector(".t951__cont-w-filter").insertAdjacentHTML("beforeend", x);
                        else if (!s) {
                    ...
                    if (x) {
                        x.style.display = "";
                        var P = function t() {
                            window.tStoreProductsRequested || (x.classList.add("t-btn_sending"), t_store_loadProducts("", e, r, _.nextslice))
                        };
                        x.parentNode.replaceChild(x.cloneNode(!0), x), (x = c.querySelector(".js-store-load-more-btn")).addEventListener("click", P)
                    }
                ...
                })), l.style.height = "", t_store_triggerEvent(document.body, "twishlist_addbtn"), t_store_triggerEvent(l, "tStoreRendered"), window.tStoreProductsRequested = !1
            }
...
function t_store_loadOneProduct(t, e, r, o, i) {
    ...
    if (d.onload = function() {
            ...
            console.log("Can't get product with uid = " + r + " in storepart = " + e.storepart), "function" == typeof i && i(t)
    ...
    d.open("GET", "https://" + window.t_store_endpoint + "/api/getproduct/?" + t_store__serializeData(n)), d.timeout = 2e4, d.send()
}
...
function t_store_loadProducts_byId(t, e, r, o) {
    ...
    l.onload = function() {
        l.readyState === l.DONE && 200 === l.status && ("string" == typeof l.responseText && "{" === l.responseText.substring(0, 1) || console.log("Can't get products array by uid list"), r(JSON.parse(l.responseText)))
...
function t_store_loadFilters(t, e, r) {
    ...
    if (t && t.defaultSort && t.defaultSort.in_stock && (s.filters || (s.filters = {}), s.filters.quantity = "y"), !window.t_store_endpoint) {
        window.t_store_endpoint = "store.tildacdn.com";
        try {
            if (a) {
    ...
    if (a) {
        ...
        if (n) {
            var d = "973" === a.getAttribute("data-record-type"),
                ...
                p = document.getElementById("allrecords") !== document.querySelector(".t-store__product-snippet") && document.getElementById("allrecords").contains(document.querySelector(".t-store__product-snippet"));
            ...
            if (i && r.relevants_slider && r.prodCard) {
            ...
            if (i && r.relevants_slider && (t.length > 4 || window.innerWidth <= 960) || !i && d) {
                var z = "",
                    R = "300";
                "fast" === r.slider_opts.anim_speed && (z = "t-slds_animated-fast"), "slow" === r.slider_opts.anim_speed && (z = "t-slds_animated-slow", R = "500"), O += '<div class="t-slds" style="visibility: hidden;">', O += '<div class="t-slds__main t-container">', O += '<div class="t-slds__container">', O = (O += '<div class="t-slds__items-wrapper ' + z + '" data-slider-items-in-row="' + (!i && d ? T : 4) + '" data-slider-transition="' + R + '" data-slider-with-cycle="true" data-slider-cycle="yes" data-slider-correct-height="' + (!i && d ? "true" : "false") + '" data-auto-correct-mobile-width="false">').replace("[[noCycleClass]]", r.slider_opts.cycle ? "" : "t-slds__nocycle").replace("[[isCycled]]", r.slider_opts.cycle ? "true" : "false")
            }
            if (Array.prototype.forEach.call(t, (function(t) {
                    ...
                    (!i && !d && !c || i && !r.relevants_slider) && g > 0 && g % T == 0 && (O += _), O += t_store_get_productCard_html(a, e, r, i, o, t), u[e.uid] = e, g++
                })), i && r.relevants_slider && (t.length > 4 || window.innerWidth <= 960) || !i && d) {
                var M, U = a.querySelector(".js-store-tpl-slider-arrows").innerHTML;
                if (O += "</div>", O += "</div>", U && !i && d && (O += U, n.classList.remove("t-container"), n.classList.remove("t-store__grid-cont_mobile-grid")), !i && d) {
                    var D = '<div class="t-slds__bullet_wrapper">';
                    Array.prototype.forEach.call(t, (function(t, e) {
                        var r = e + 1;
                        D += '<div class="t-slds__bullet' + (1 === r ? " t-slds__bullet_active" : "") + '" data-slide-bullet-for="' + r + '"><div class="t-slds__bullet_body" style="background-color: transparent;"></div></div>'
                    })), O += D += "</div>"
                }
                O += "</div>", O += "</div>", U && i && (O += U)
            }
            if (t_store_process_appendAndShowProducts(a, n, O), -1 === O.indexOf('data-animate-style="fadeinleft"') || n.classList.contains("t-store__grid-cont_mobile-one-row") || (n.style.overflowX = "hidden"), Array.prototype.forEach.call(t, (function(t) {
                                    ...
                                    "object" == typeof s && s.slice().reverse().forEach((function(t) {
                                        if (!r)
                                            if (t !== o.value) {
                                                ...
                                                e && !e.getAttribute("disabled") && (o.value = t, t_store_triggerEvent(o, "change"), r = !0)
            ...
            if ("y" !== window.lazy && "yes" !== document.getElementById("allrecords").getAttribute("data-tilda-lazy") || (r.relevants_slider ? setTimeout((function() {
                    ...
                    t_lazyload_update()
                }))), document.querySelector(".t706__cartwin") || document.querySelector(".t706__sidebar") ? "function" == typeof tcart__addEvent__links && tcart__addEvent__links(e) : console.log("Warning: cart block is not added to this page"), t_store_initPopup(e, u, r, i, s), "1025" == r.prodCard.blockId ? setTimeout((function() {
...
function t_store_mobileHoriz_checkBtnVisibility(t, e) {
    var r = function t(e, r) {
        var o = document.getElementById("rec" + e),
            i;
        window.innerWidth < 960 && r.hasMobileHorizScroll && t_store__removeElement(o.querySelector(".js-store-load-more-btn"))
    };
...
function t_store_get_productPopup_html(t, e) {
    ...
    var l = "",
        ...
        _, u = "t-align_" + ("center" === e.popup_opts.align ? "center" : "left") + " " + (e.popup_opts.isVertical ? "" : "t-store__prod-popup__col-right t-col t-col_" + e.popup_opts.columns2),
        g = "js-store-product js-product t-store__product-popup ";
    e.popup_opts.containerBgColor && (l += "background-color:" + e.popup_opts.containerBgColor + ";"), "100" === e.popup_opts.popupContainer && (l += "max-width:100%;", g += "t-container_fluid "), r += '<div class="t-popup" ' + o + " " + i + ">", r += t_store_get_productPopup_closeIcon_html(e), r += t_store_get_productPopup_closeText_html(e), r += '<div class="' + s + '" style="' + l + '" >', r += "<div>", r += '<div class="t-store__prod-popup__container">', r += '<div class="' + g + '">';
    var v = [];
    return "100" === e.popup_opts.popupContainer && v.push("t-container_fluid"), r += v.length ? '<div class="' + v.join(" ") + '">' : "<div>", r += '<div class="t-store__prod-popup__slider js-store-prod-slider ' + p + '"></div>', r += '<div class="t-store__prod-popup__info ' + u + '">', r += t_store_get_productPopup_titleText_html(), r += '<div class="js-store-price-wrapper t-store__prod-popup__price-wrapper">', r += t_store_get_productPopup_onePrice_html(e, "current"), r += t_store_get_productPopup_onePrice_html(e, "old"), r += "</div>", r += '<div class="js-product-controls-wrapper"></div>', r += t_store_get_productPopup_linksSizeChart_html(), r += t_store_get_productPopup_buyBtn_html(e), r += t_store_get_productPopup_text_html(), r += "</div>", r += "</div>", r += "</div>", n && (r += '                <div class="t-store__relevants__container">', r += '                    <div class="t-store__relevants__title-wrapper">', r += '                        <div class="t-store__relevants__title t-uptitle t-uptitle_xxl"' + (Object.prototype.hasOwnProperty.call(e.typo, "title") ? 'style = "' + e.typo.title + '"' : "") + ">" + d + "</div>", r += "                    </div>", e.relevants_slider || (r += t_store_get_handIcon_html(t, e.horizontalScrollHint)), r += '                    <div class="t-store__relevants-grid-cont js-store-relevants-grid-cont ' + a + " " + c + '"></div>', r += "                </div>"), r += "            </div>", r += "        </div>", r += "    </div>", r += "</div>"
}
...
function t_store_get_productPopup_onePrice_html(t, e) {
    var r = "",
        ...
        i = Object.prototype.hasOwnProperty.call(t.price, "fontWeight") && Object.prototype.hasOwnProperty.call(t.price, "fontSize"),
        s, a = "",
        n = "current" === e ? t.price.color : t.price.colorOld,
        d = t.popup_opts.containerBgColor;
    0 === Math.abs(t_store_getLightnessColor(n) - t_store_getLightnessColor(d)) && (n = t_store_luma_rgb(d), i || (a += n ? "color:" + n + ";" : "")), i && (a += n ? "color:" + n + ";" : "", a += t.price.fontWeight ? "font-weight:" + t.price.fontWeight + ";" : ""), s = "" !== a ? 'style = "' + a + '"' : "";
    var c = t.currencyTxt ? '<div class="t-store__prod-popup__price-currency" translate="no">' + t.currencyTxt + "</div>" : "",
        l = "current" === e ? "js-product-price js-store-prod-price-val" : "js-store-prod-price-old-val";
    return r += '<div class="' + o + ' t-store__prod-popup__price-item t-name t-name_md" ' + s + ">", r += "r" !== t.currencySide && c ? c : "", r += '<div class="' + l + ' t-store__prod-popup__price-value" translate="no"></div>', r += "r" === t.currencySide && c ? c : "", r += "</div>"
}
...
function t_store_get_errorBox(t, e) {
    ...
    return r += "\x3c!--googleoff: all--\x3e", r += "\x3c!--noindex--\x3e", r += '<div class="' + (i += t.colClassFullWidth ? " " + t.colClassFullWidth : "") + '" style="display:none;">', r += '    <div class="t-store__error-msg-wrapper t-descr t-descr_sm" style="' + o + '">', r += '        <div class="t-store__error-msg">', r += "        " + e, r += "        </div>", r += "    </div>", r += "</div>", r += "\x3c!--/noindex--\x3e", r += "\x3c!--googleon: all--\x3e"
}
...
function t_store_get_productCard_html(t, e, r, o, i, s) {
    ...
    var k = e.url || "",
        P = "";
    v && ("2" === r.prodCard.style ? P += " t-store__card_in-row" : "3" === r.prodCard.style ? P += " t-store__card_under-description" : P += " t-store__card_in-column", P += r.prodCard.hasSeparator ? "" : " t-store__card_no-separator", P += parseInt(r.rightColumnWidth, 10) ? " t-store__card_fixed-width" : "", P += r.verticalAlign ? " t-store__card_verticalAlign_" + r.verticalAlign : "");
    var L = [];
    try {
...
function t_store_get_productCard_getWrapperStylesStr(t) {
    ...
    var r = t.prodCard.shadowOpacity,
        ...
        i = t.prodCard.shadow,
        s = "";
    return i ? s = "box-shadow:" + i + ";" : (r || o) && (r = r ? parseInt(r, 10) / 100 : .3, s = "box-shadow: 0px 0px " + (o = o ? parseInt(o, 10) : 10) + "px rgba(0,0,0," + r + ");"), e += s
}
...
function t_store_get_productCard_img_html(t, e, r) {
    ...
    if ("" !== (g = g.replace(/&amp;amp;/, "&amp;"))) {
        ...
        else(u = document.createElement("div")).classList.add("js-product-img"), u.classList.add("t-store__card__bgimg"), _ && u.classList.add("t-store__card__bgimg_hover"), u.classList.add("t-bgimg"), u.setAttribute("data-original", g), u.style.backgroundImage = 'url("' + t_store_getLazyUrl(e, g) + '")', t_store_get_productCard_getImgStyles(u, e);
        ...
        return i += '<div class="' + a + '" style="' + c + '">', i += "    " + t_store_get_productCard_mark_html(t, e), i += "    " + u.outerHTML, i += "    " + (e.imageHover ? p : ""), i += "</div>"
    }
    return ""
}
...
function t_store_get_productCard_imgElHover_html(t, e, r) {
    if (t.gallery && "[" === t.gallery[0]) {
        ...
        if (void 0 !== o[1]) {
            ...
            if (e.hasOriginalAspectRatio)(s = document.createElement("img")).classList.add("t-store__card__img"), s.classList.add("t-store__card__img_second"), s.classList.add("t-img"), s.setAttribute("data-original", i), s.src = t_store_getLazySrc(e, i), /Version\/16\.3 Safari/.test(navigator.userAgent) && (s.style.objectFit = "contain");
            else(s = document.createElement("div")).classList.add("t-store__card__bgimg", "t-store__card__bgimg_second"), s.classList.add("t-bgimg"), s.setAttribute("data-original", i), s.style.backgroundImage = 'url("' + t_store_getLazyUrl(e, i) + '")', t_store_get_productCard_getImgStyles(s, e);
            return s.outerHTML
        }
    }
    return ""
...
function t_store_get_productCard_txt_html(t, e, r) {
    ...
    if (Object.prototype.hasOwnProperty.call(r.price, "position") && "at" === r.price.position && (o += t_store_get_productCard_Price_html(t, e, r)), t.title) {
        ...
        o += '<div class="js-store-prod-name js-product-name t-store__card__title t-typography__title t-name ' + i + '"' + (Object.prototype.hasOwnProperty.call(r.typo, "title") ? 'style="' + r.typo.title + '"' : "") + s + ">", o += t.title, o += "</div>"
    }
    if (Object.prototype.hasOwnProperty.call(r.price, "position") && "bt" === r.price.position && (o += t_store_get_productCard_Price_html(t, e, r)), e.sku) {
        ...
        o += '<div class="t-store__card__sku t-descr t-descr_xxs" ' + d + ">", o += window.tStoreDict.sku + ": ", o += '<span class="js-store-prod-sku js-product-sku" translate="no" ' + c + ">", o += e.sku, o += "</span>", o += "</div>"
    }
    if (t.descr) {
        var l = 1 === t.editions.length && e.uid ? 'field="st_descr__' + e.uid + '" data-redactor-toolbar="no"' : "";
        o += '<div class="js-store-prod-descr t-store__card__descr t-typography__descr t-descr t-descr_xxs" ' + (Object.prototype.hasOwnProperty.call(r.typo, "descr") ? 'style="' + r.typo.descr + '"' : "") + l + ">", o += t.descr, o += "</div>"
    }
    return o
}
...
function t_store_get_productCard_onePrice_html(t, e, r, o) {
    ...
    var d = "current" === o ? "price" : "priceold",
        ...
        p, _ = "",
        u;
    if (_ += i && "0" !== i && "0.0000" !== i ? "" : "display: none;", Object.prototype.hasOwnProperty.call(r.price, "fontWeight") && Object.prototype.hasOwnProperty.call(r.price, "fontSize")) {
        var g = "current" === o ? r.price.color : r.price.colorOld;
        _ += g ? "color:" + g + ";" : "", _ += r.price.fontSize ? "font-size:" + r.price.fontSize + ";" : "", _ += r.price.fontWeight ? "font-weight:" + r.price.fontWeight + ";" : ""
    }
    p = "" !== _ ? 'style = "' + _ + '"' : "";
    var v = 1 === t.editions.length && e.uid ? 'field="st_' + d + "__" + e.uid + '" data-redactor-toolbar="no"' : "",
        ...
        f;
    if (n && (y += " js-store-prod-price-range-val"), c += '<div class="' + l + " t-store__card__price-item t-name t-name_" + ("1025" === r.prodCard.blockId ? "md" : "xs") + '" ' + p + ">", n && "from" === a) {
        c += '<div class="t-store__card__price-from t-store__card__price-value" translate="no" ' + v + ">" + window.tStoreDict.from + "</div>";
        var h = t_store__getFormattedMinPrice(r, t);
        null !== h && (s = h)
    }
    return c += "r" !== r.currencySide && m ? m : "", c += '<div class="' + y + ' t-store__card__price-value" translate="no" ' + v + ">" + s + "</div>", c += "r" === r.currencySide && m ? m : "", t.unit && t.portion > 0 && (c += '<div class="t-store__prod__price-portion"><span class="t-store__prod__price-portion-slash">/</span>', "1" !== t.portion && (c += +t.portion + " "), c += window.tStoreDict[t.unit] + "</div>"), c += "</div>"
}
        ...
        Array.prototype.forEach.call(c, (function(a) {
            ...
            var p = function s(a) {
                if (a.preventDefault(), !a.target.closest(".t1002__addBtn")) {
                    ...
                    d || p ? window.open(l.url) : (i.header || i.footer) && i.disablepopup ? location.href = l.url : t_store_openProductPopup(t, r, l, o, !1, !!o)
                }
            };
...
function t_store_openProductPopup(t, e, r, o, i, s) {
    ...
    var n = e.showRelevants,
        ...
        l, p;
    if (c && t_store_drawProdPopup(t, c, r, e, s), t_store_showPopup(t, i, s), window.Tilda && (Tilda.sendEcommerceEvent && (window.tStoreDetailEvent || (window.tStoreDetailEvent = {}), window.tStoreDetailEvent[r.id ? r.id : r.uid] || (Tilda.sendEcommerceEvent("detail", [{
            id: "" + (r.id ? r.id : r.uid),
            uid: "" + r.uid,
            price: "" + (r.price_min ? r.price_min : r.price),
            sku: r.sku ? r.sku : "",
        ...
        if ("list" === r.showStoreBtnQuantity && t.classList.contains("t-store__card") || "popup" === r.showStoreBtnQuantity && t.classList.contains("t-store__product-snippet") || "popup" === r.showStoreBtnQuantity && t.classList.contains("t-store__product-popup") || "both" === r.showStoreBtnQuantity) {
            ...
            if (a) {
                ...
                var p = "",
                    ...
                    u = "",
                    g = "";
                if (t.classList.contains("t-store__card") && (g = "", "sm" === r.btnSize && (g = "t-store__prod__quantity_xs")), "" !== _ && _) {
                ...
                var y = "";
                if ("" !== u && (y = "border-radius:" + u + ";"), p += '<div class="t-store__prod__quantity ' + g + '" style="' + y + '">', p += '<div class="t-store__prod__quantity__minus-wrapper">', p += '<span class="t-store__prod__quantity__minus"></span>', p += "</div>", p += '<input class="t-store__prod__quantity-input t-descr t-descr_xxs" type="number" min="1" max="9999" step="1" value="1" size="4" maxlength="4" />', p += '<div class="t-store__prod__quantity__plus-wrapper">', p += '<span class="t-store__prod__quantity__plus"></span>', p += "</div>", p += "</div>", o ? o.insertAdjacentHTML("beforebegin", p) : i && i.insertAdjacentHTML("beforebegin", p), t_store_addProductQuantityEvents(t), d = (a = t.querySelector(".t-store__prod__quantity")).querySelector(".t-store__prod__quantity-input"), i) {
                    var f = i.parentNode;
...
function t_store_initTextAndCharacteristics(t, e) {
    ...
    if (_ && e.characteristics.forEach((function(t) {
        ...
        })), w += '<p class="js-store-prod-dimensions t-typography__characteristics"></p>', h += w += '<p class="js-store-prod-weight t-typography__characteristics"></p>', h += "</div>", o && (o.insertAdjacentHTML("beforeend", y), o.insertAdjacentHTML("beforeend", h), o.style.display = ""), r && m.length && Array.prototype.forEach.call(m, (function(t, e) {
    ...
    if (p) {
        ...
        t.querySelector(".js-store-prod-weight").innerHTML = A, r && (m.length && Array.prototype.forEach.call(m, (function(t) {
            var e = t.querySelector(".js-store-prod-weight");
            e && (e.innerHTML = A)
        })), t.setAttribute("data-product-pack-m", s))
    }
    var x = t.querySelector(".js-store-product");
    r && t.classList.contains("js-store-product") && (x = t), x && (x.setAttribute("data-product-pack-label", i), x.setAttribute("data-product-pack-m", s), x.setAttribute("data-product-pack-x", a), x.setAttribute("data-product-pack-y", n), x.setAttribute("data-product-pack-z", d), x.setAttribute("data-product-url", c))
}
...
function t_store_addProductOptions(t, e, r, o) {
    ...
    if (i) {
        ...
        var s = document.getElementById("allrecords") !== document.querySelector(".t-store__product-snippet") && document.getElementById("allrecords").contains(document.querySelector(".t-store__product-snippet")),
            ...
            n, d;
        if (t_store_product_initEditions(t, e, r, o), e.prod_option || e.prod_option2 || e.prod_option3 || e.prod_option4 || e.prod_option5)["", 2, 3, 4, 5].map((function(t) {
            return {
...
function t_store_product_getMultioptionCheckboxesEl(t, e) {
    var r = function t(e, r) {
            var o;
            return '<label class="t-checkbox__control t-checkbox__control_flex t-descr t-descr_xxs">    <input class="t-checkbox" type="checkbox" name="' + e + '" data-product-variant-price="' + r + '">    <div class="t-checkbox__indicator"></div>    <span class="">' + e + "</span></label>"
        },
        o, i = e.values.split("\n").reduce((function(t, e) {
            var o = e.split("="),
                i = o[0],
        ...
        s = '<div class="t-product__option js-product-multioption">    <div class="js-product-option-name t-product__option-title t-typography__options t-descr t-descr_xxs">' + e.title + '</div>    <div class="t-product__checkbox-wrap">        ' + i + "    </div></div>",
...
function t_store_option_styleCustomControl(t, e, r, o, i) {
    ...
    if (a) {
        ...
        if (n) {
            ...
            s += '<span class="t-product__option-selected-title">' + l + "</span>", s += "</div>", p += " t-product__option-variants_hidden"
        }
        ...
        for (var S = 0; S < r.values.length; S++) {
            ...
            if ("" !== (f = r.values[S])) {
                var E = i[r.name] === f,
                    ...
                    h, w;
                if (s += '<label class="t-product__option-item ' + x + _ + '">', s += '<input class="t-product__option-input ' + u + '" type="radio" name="' + r.name + '" value="' + t_store_escapeQuote(f) + '"' + A + ">", c && r.imagesObj) s += '<div class="t-product__option-checkmark t-bgimg ' + g + '"' + (C = (w = t_store_getLazyUrl(e, h = r.imagesObj[f])) ? " style=\"background-image: url('" + w + "');\"" : "") + ' data-original="' + h + '"></div>';
                else s += '<div class="t-product__option-checkmark ' + g + '"' + C + "></div>";
                s += '<span class="t-product__option-title ' + v + ' t-typography__options t-descr t-descr_xxs">' + f + "</span>", s += "</label>"
            }
        }
...
function t_store_showPopup(t, e, r) {
    ...
    t_store_resetNavStyles(t), t_store_triggerEvent(document.body, "popupShowed"), document.body.classList.add("t-body_popupshowed"), i.style.display = "block";
    var s = i.scrollHeight > document.documentElement.clientHeight;
    s || (i.style.overflow = "hidden"), setTimeout((function() {
        i.querySelector(".t-popup__container").classList.add("t-popup__container-animated"), i.classList.add("t-popup_show"), t_store_triggerEvent(document.body, "twishlist_addbtn"), "y" !== window.lazy && "yes" !== document.getElementById("allrecords").getAttribute("data-tilda-lazy") || t_store_onFuncLoad("t_lazyload_update", (function() {
            t_lazyload_update()
        })), s ? (i.scrollTop = 0, t_store_triggerEvent(i, t_store_POPUP_SHOWED_EVENT_NAME)) : setTimeout((function() {
...
function t_store_resetNavStyles(t) {
    ...
    e.classList.contains("t-popup__close-solid") ? e.style.backgroundColor = "rgba(255,255,255,1)" : e.classList.contains("t-popup__close-opacity-scroll") && (e.style.backgroundColor = "rgba(255,255,255,0)")
}
...
function t_store_closePopup(t, e, r) {
    ...
    if (document.getElementById("allrecords") !== document.querySelector(".t-store__product-snippet") && document.getElementById("allrecords").contains(document.querySelector(".t-store__product-snippet")) || t_store_closePopup_routing(), Array.prototype.forEach.call(document.querySelectorAll(".t-popup"), (function(t) {
        ...
        if (t_store_isQueryInAddressBar("tstore")) {
            var c = decodeURI(window.location.hash).split("/"),
                ...
                p = c.indexOf("r") + 1,
                a, _ = c[p];
            a = -1 !== c[l].indexOf("-") ? c[l].slice(0, c[l].indexOf("-")) : c[l], window.history.state && ((n = window.history.state.opts).storepart = a), t_store_isStorepartFromHistoryActive(a, e, r) || t_store_loadProducts("", _, n)
    ...
    e && (document.getElementById("rec" + e).querySelector(".js-store-parts-switcher") && !r.hideStoreParts && t_store_setActiveStorePart(e), r.tabs && t_store_onFuncLoad("t_store_tabs_videoClearFrame", (function() {
        t_store_tabs_videoClearFrame(e)
    })));
    var v = document.querySelector(".t-popup");
    setTimeout((function() {
        v.scrollTop = 0, Array.prototype.forEach.call(document.querySelectorAll(".t-popup:not(.t-popup_show)"), (function(t) {
            t.style.display = "none"
        }))
    }), 300), document.removeEventListener("keydown", t_store_closePopupKeyDown), window.removeEventListener("resize", window.t_store_prodPopup_updateGalleryThumbsEvent), t_store_triggerEvent(document.body, "twishlist_addbtn"), t_store_triggerEvent(v, t_store_POPUP_CLOSED_EVENT_NAME)
}
...
function t_store_copyTypographyFromLeadToPopup(t, e) {
    ...
    if (s && (a = s.style.backgroundColor), o) {
        var d = o.getAttribute("style"),
            ...
            l;
        if (c)
            if (c.setAttribute("style", t_store_removeSizesFromStylesLine(d)), a) t_store_applyContrastColorIfNecessary(c, e.typo.titleColor, a)
    }
    i && (n = i.getAttribute("style")), !n && e && e.typo && e.typo.descr && (n = (n = e.typo.descr).replace("line-height:0;", ""));
    var p = r.querySelector(".t-popup .js-store-prod-text"),
        _;
    p && (p.setAttribute("style", t_store_removeSizesFromStylesLine(n)), a && t_store_applyContrastColorIfNecessary(p, e.typo.descrColor, a))
}
...
function t_store_snippet_copyTypographyToSnippet(t, e) {
    ...
    if (s) {
        var a = s.getAttribute("style"),
            n;
        if (s.setAttribute("style", t_store_removeSizesFromStylesLine(a)), i) t_store_applyContrastColorIfNecessary(s, e.typo.titleColor, i)
    }
    var d = o.querySelector(".js-store-prod-text");
    if (console.log(d), d) {
        var c = d.getAttribute("style"),
            l;
        if (d.setAttribute("style", t_store_removeSizesFromStylesLine(c)), i) t_store_applyContrastColorIfNecessary(d, e.typo.descrColor, i)
    }
            ...
            if (0 !== (n = "string" == typeof r.gallery ? JSON.parse(r.gallery) : r.gallery).length) {
                var d = function a() {
                    var d = {
                        ...
                        c, l = window.isMobile || "ontouchend" in document && -1 !== navigator.userAgent.indexOf("AppleWebKit") ? document.documentElement.clientWidth : window.innerWidth;
                    if (o.galleryStyle && l > i || o.popup_opts.mobileGalleryStyle && l <= i) t_store__loadJSFile(s, (function() {
                ...
                d(), window.t_store_drawProdPopup_resizeGalleryEvent && window.removeEventListener("resize", window.t_store_drawProdPopup_resizeGalleryEvent), window.t_store_drawProdPopup_resizeGalleryEvent = function() {
                    var t, e = window.isMobile || "ontouchend" in document && -1 !== navigator.userAgent.indexOf("AppleWebKit") ? document.documentElement.clientWidth : window.innerWidth,
            ...
            if (o) {
                ...
                if (i) {
                    var s = t.recid || "",
                        ...
                        d = "",
                        c = "",
                        l = "thumbs" === r.slider_opts.controls || "arrowsthumbs" === r.slider_opts.controls || "dots" === r.slider_opts.controls || "" === r.slider_opts.controls,
    ...
    if (e) {
        ...
        Array.prototype.forEach.call(r, (function(t) {
            t && t.addEventListener("click", (function() {
                ...
                r || ((r = document.createElement("div")).classList.add("t-slds__frame-wrapper"), this.insertAdjacentElement("afterend", r)), r.style.zIndex = 3;
...
function t_store__getVideoElement(t, e) {
        ...
        var r = e.videoId,
            ...
            n, d, c = {
                ...
                vimeo: {
                    ...
                    params: ["title=0", "byline=0", "portrait=0", "badge=0", "color=ffffff", "autoplay=1", "muted=1", o && "h=" + o],
                    hashtag: i ? "#t=" + i : ""
                },
                kinescope: {
    ...
    function m(t, e) {
        ...
        for (var o in r.src = t, r.classList.add("t-slds__frame"), r.width = "100%", r.height = "100%", r.frameBorder = "0", r.allowFullscreen = !0, r.setAttribute("mozallowfullscreen", "true"), r.setAttribute("msallowfullscreen", "true"), r.setAttribute("oallowfullscreen", "true"), r.setAttribute("webkitallowfullscreen", "true"), r.scrolling = "no", r.allow = "clipboard-write; autoplay; fullscreen; picture-in-picture; encrypted-media; gyroscope; accelerometer;", e) e.hasOwnProperty(o) && r.setAttribute(o, e[o]);
        return r
    }
}
...
function t_store_svgVideoIcon(t) {
    var e = "",
        r;
    return e += '<svg xmlns="http://www.w3.org/2000/svg" width="70px" height="70px" viewBox="0 0 60 60" style="width:100%;height:100%;">', e += '<g stroke="none" stroke-width="1" fill="" fill-rule="evenodd">', e += '<g transform="translate(-691.000000, -3514.000000)" fill="' + (t.slider_opts.videoPlayerIconColor || "#fff") + '">', e += '<path d="M721,3574 C737.568542,3574 751,3560.56854 751,3544 C751,3527.43146 737.568542,3514 721,3514 C704.431458,3514 691,3527.43146 691,3544 C691,3560.56854 704.431458,3574 721,3574 Z M715,3534 L732,3544.5 L715,3555 L715,3534 Z"></path>', e += "</g>", e += "</g>", e += "</svg>"
}
...
function t_store_product_initEditions(t, e, r, o) {
    ...
    if (t_store_product_addEditionControls(e, i, o, t), t_store_product_selectAvailableEdition(t, e, r, o)) {
        ...
        a && t_store_addProductQuantity(r, a, o), t_store_product__verifyOptionConsisency(r, e), t_store_product_disableUnavaileOptions(r, e)
    } else t_store_product_triggerSoldOutMsg(r, !0, o), t_store_removeProductQuantity(r), t_store_product_disableUnavaileOptions(r, e);
    ...
    Array.prototype.forEach.call(r.querySelectorAll(".js-product-edition-option"), (function(i) {
        i.addEventListener("change", (function() {
            ...
            if (i) {
                ...
                t_store_product_triggerSoldOutMsg(r, a, o), a ? t_store_removeProductQuantity(r) : t_store_addProductQuantity(r, i, o), window.Tilda && Tilda.sendEcommerceEvent && (window.tStoreDetailEvent || (window.tStoreDetailEvent = {}), window.tStoreDetailEvent[i.id ? i.id : i.uid] || (Tilda.sendEcommerceEvent("detail", [{
                    id: "" + (i.id ? i.id : i.uid),
                    uid: "" + i.uid,
                ...
                for (var n = this.getAttribute("data-edition-option-id"), c = [], l = 0; l < e.editionOptions.length; l++) {
                    var p = e.editionOptions[l];
                    if (c.push(p), p.name === n) break
                }
                var _ = t_store_product_selectAvailableEdition(t, e, r, o, c, s);
                t_prod__updatePrice(r, o), t_store_product_triggerSoldOutMsg(r, !_, o), t_store_addProductQuantity(r, e, o)
            }
            d && t_store_triggerEvent(d, "displayChanged"), Array.prototype.forEach.call(r.querySelectorAll(".js-product-edition-option-variants option"), (function(t) {
...
function t_store_product_selectAvailableEdition(t, e, r, o, i, s) {
    ...
    if (Array.prototype.forEach.call(e.editionOptions, (function(t) {
            ...
            if (i) {
                ...
                n && (n.value = (e || "").replace(/&gt;/g, ">").replace(/&lt;/g, "<").replace(/&#92;/g, "\\"), o.prodCard && o.prodCard.showOpts && (s = !0));
                ...
                Array.prototype.forEach.call(c, (function(t) {
                    ...
                    Array.prototype.forEach.call(r, (function(t) {
                        ...
                        })), o.prodCard && o.prodCard.showOpts && (s = !0)) : (r.checked = !1, t.classList.remove("t-product__option-item_active"))
                    }))
                }))
            }
        ...
        var l, p = t_store_snippet_getJsonFromUrl().editionuid,
            _;
        p && document.querySelector("#rec" + t + " .js-product").getAttribute("data-product-uid") !== p && e.editions.forEach((function(t) {
            t.uid === p && (_ = t)
...
function t_store_product__verifyOptionConsisency(t, e) {
    ...
    for (var s = 1; s < e.editionOptions.length; s++) {
        ...
        i.push(a), Array.prototype.forEach.call(a.values, (function(r) {
            ...
            if (s) {
                var l;
                if (d && d.removeAttribute("disabled"), c)(l = c.closest(".t-product__option-item")).classList.remove("t-product__option-item_disabled"), d && d.parentNode.value === a && (o || c.click())
            } else {
                ...
                var l;
                if (c)(l = c.closest(".t-product__option-item")).classList.add("t-product__option-item_disabled"), l.classList.remove("t-product__option-item_active"), c.checked = !1
            }
        }))
    }
}
...
function t_store_product_disableUnavaileOptions(t, e) {
    ...
    if (!document.querySelector(".t1122") && 0 !== e.editionOptions.length) {
        ...
        (!window.tStoreDisabledOptionsList || window.tStoreDisabledOptionsList && !window.tStoreDisabledOptionsList[o]) && t_store_product_generateOptionsListForDisable(t, e);
        var i = window.tStoreDisabledOptionsList[o];
        i && 0 !== i.length && Array.prototype.forEach.call(i, (function(e) {
            Object.keys(e).forEach((function(r) {
                var o = t.querySelector('.js-product-edition-option[data-edition-option-id="' + (r || "").replace(/"/g, '\\"') + '"]');
                if (o) {
                    ...
                    if (n) {
                        ...
                        d.classList.add("t-product__option-item_disabled"), d.classList.remove("t-product__option-item_active")
                    }
                }
            }))
        }))
...
function t_store_product_generateOptionsListForDisable(t, e) {
    ...
    window.tStoreDisabledOptionsList = window.tStoreDisabledOptionsList || {}, window.tStoreDisabledOptionsList[r] = [], e.editionOptions.forEach((function(t) {
...
function t_store_product_updateEdition(t, e, r, o, i, s) {
    ...
    if (a.editionuid = parseInt(a.editionuid, 10), window.jQuery && e instanceof jQuery && (e = e[0]), r || o.editions.forEach((function(t) {
            ...
            if (i) {
                ...
                s && s.value !== o && (s.value = (o || "").replace(/&gt;/g, ">").replace(/&lt;/g, "<"), setTimeout((function() {
        ...
        if (u && (u.setAttribute("data-product-price-def", _), u.setAttribute("data-product-price-def-str", _)), Array.prototype.forEach.call(e.querySelectorAll(".t-store__prod__price-portion"), (function(t) {
    ...
    if (r.priceold && "0" !== r.priceold) {
        var m = t_store__getFormattedPrice(i, r.priceold),
            y, f, h;
        (y = e.querySelector(".js-store-prod-price-old")) && (y.style.display = ""), (f = e.querySelector(".t-store__card__price_old")) && (f.style.display = ""), (h = e.querySelector(".js-store-prod-price-old-val")) && (h.innerHTML = m)
    } else {
        var y, f, h;
    ...
    try {
        ...
        if (r.pack_x && r.pack_y && r.pack_z) {
            ...
            C = window.tStoreDict["product-" + A.pack_label] + ": " + q + "&nbsp;" + window.tStoreDict.mm, j && (e.querySelector(".js-store-prod-dimensions").innerHTML = C)
        } else if (A && A.pack_x) {
            ...
            var q = A.pack_x + "x" + A.pack_y + "x" + A.pack_z,
                j;
            C = window.tStoreDict["product-" + A.pack_label] + ": " + q + "&nbsp;" + window.tStoreDict.mm, (j = e.querySelector(".js-store-prod-dimensions")) && (j.innerHTML = C)
        }
        ...
        var k = "",
            P;
        if (r.pack_m) e.setAttribute("data-product-pack-m", r.pack_m), k = window.tStoreDict["product-weight"] + ": " + r.pack_m + "&nbsp;" + window.tStoreDict.g, (P = e.querySelector(".js-store-prod-weight")) && (P.innerHTML = k);
        else if (A && parseFloat(A.pack_m) > 0) {
            var P;
            e.setAttribute("data-product-pack-m", A.pack_m), k = window.tStoreDict["product-weight"] + ": " + A.pack_m + "&nbsp;" + window.tStoreDict.g, (P = e.querySelector(".js-store-prod-weight")) && (P.innerHTML = k)
        }
    ...
    o.unit && o.portion > 0 ? (e.setAttribute("data-product-unit", o.unit), e.setAttribute("data-product-portion", o.portion), e.setAttribute("data-product-single", o.single)) : (e.removeAttribute("data-product-unit"), e.removeAttribute("data-product-portion"), e.removeAttribute("data-product-single"))
}
...
function t_store_product_updateEdition_moveSlider(t, e, r) {
    if (e && r && r.img) {
        ...
        if (o) {
            ...
            d && 0 === (i = parseInt(d.getAttribute("data-slide-index"), 10)) && (i = s), o.setAttribute("data-slider-pos", i.toString()), e.classList.contains("t922") || t_store_onFuncLoad("t_slideMoveInstantly", (function() {
...
function t_store_product_triggerSoldOutMsg(t, e, r) {
    ...
    if (e) {
        var n = function e() {
            ...
            if (r) {
                var o = '<div class="js-store-prod-sold-out t-store__card__sold-out-msg t-name t-name_xs">' + window.tStoreDict.soldOut + "</div>";
        ...
        "small" === t.getAttribute("data-card-size") && (i && r.prodCard.btnTitle1 && (d = r.prodCard.btnTitle1), s && r.prodCard.btnTitle2 && (d = r.prodCard.btnTitle2)), a && (a.textContent = d), t_store_triggerEvent(t, "tStoreAvailable", {
            product: t_store__collectProductDataByElement(t),
            buttonBuyElement: o[0]
        })
    }
...
function t_store_product_addOneOptionsControl(t, e, r, o, i, s) {
    if (e.name) {
        ...
        })), "" !== c && (a = (d = t_store_get_control_editionOption_html(o, e)).replace(/\[\[id\]\]/g, e.id.replace(/&amp;/g, "&amp;amp;").replace(/&#92;/g, "&amp;#92;")).replace(/\[\[name\]\]/g, e.name).replace(/\[\[optiontags\]\]/g, c));
...
function t_store_product_getEditionOptionsArr(t, e) {
    var r = t.editions,
        o = ["quantity", "price", "priceold", "gallery", "sku", "uid", "img", "externalid", "externalids", "pack_x", "pack_y", "pack_z", "pack_m"],
        i = {},
        s = [];
...
function t_store_product_getFirstAvailableEditionData_forCertainVals(t, e, r, o) {
    for (var i = "", s = 0; s < t.length; s++) {
        for (var a = t[s], n = !0, d = 0; d < e.length; d++) {
            ...
            if (a[c] = (a[c] || "").replace(/&#92;/g, "\\").replace(/&gt;/g, ">").replace(/&lt;/g, "<"), o && d === e.length - 1 && (p = o), a[c] !== p) {
                n = !1;
                break
            }
        }
...
function t_store_product_sortValues(t, e, r) {
    ...
    var i = "filter" === e ? t[0].value.toString() : t[0].toString(),
        ...
        a = ["XXXS", "3XS", "XXS", "2XS", "XS", "XS-S", "S", "S-M", "M", "M-L", "L", "L-XL", "XL", "XXL", "2XL", "XXXL", "3XL", "XXXXL", "BXL", "4XL", "BXXL", "5XL", "BXXXL", "6XL", "7XL", "8XL", "ONE SIZE", "ОДИН РАЗМЕР", "УНИВЕРСАЛЬНЫЙ"],
        n = ["ПОНЕДЕЛЬНИК", "MONDAY", "ВТОРНИК", "TUESDAY", "СРЕДА", "WEDNESDAY", "ЧЕТВЕРГ", "THURSDAY", "ПЯТНИЦА", "FRIDAY", "СУББОТА", "SATURDAY", "ВОСКРЕСЕНЬЕ", "SUNDAY"],
        d = ["ЯНВАРЬ", "ФЕВРАЛЬ", "МАРТ", "АПРЕЛЬ", "МАЙ", "ИЮНЬ", "ИЮЛЬ", "АВГУСТ", "СЕНТЯБРЬ", "ОКТЯБРЬ", "НОЯБРЬ", "ДЕКАБРЬ", "JANUARY", "FEBRUARY", "MARCH", "APRIL", "MAY", "JUNE", "JULY", "AUGUST", "SEPTEMBER", "OCTOBER", "NOVEMBER", "DECEMBER"],
        c, l, p, _, u, g, v = {
            watt: ["Вт", "W", "даВт", "daW", "гВт", "hW", "кВт", "kW", "мВт", "mW", "ГВт", "GW", "ТВт", "TW", "ПВт", "PW"],
            bytes: ["Кб", "Кбайт", "KiB", "KB", "Мбайт", "Мб", "MiB", "MB", "Mb", "Гбайт", "Гб", "GiB", "GB", "Gb", "Тбайт", "Тб", "TiB", "TB"],
    ...
    if (t_store_product_isSimpleOrderValid(m, a)) o = t_store_product_sortValuesByOrder(o, e, a);
        ...
        try {
            o = t.sort((function(t, r) {
                var o = "filter" === e ? t.value : t,
                    i = "filter" === e ? r.value : r;
                if (o = o.toString().replace(/^(от|from)\s+/i, ""), i = i.toString().replace(/^(от|from)\s+/i, ""), o = parseFloat(o.toString().replace(",", ".").trim()), i = parseFloat(i.toString().replace(",", ".").trim()), isNaN(o) || isNaN(i)) return 0;
                if (o === i) {
                    var s = "filter" === e ? t.value : t,
                        a = "filter" === e ? r.value : r;
                    s = s.toString().replace(/^(от|from)\s+/i, "").replace(",", ".").trim(), a = a.toString().replace(/^(от|from)\s+/i, "").replace(",", ".").trim();
...
function t_store_oneProduct_requestAllSingle(t) {
    ...
    var o = function t(r) {
        var o = r.products;
        "" !== o ? (r.options && r.options.length && !window.tStoreOptionsList && (window.tStoreOptionsList = r.options), window.tStoreSingleProdsObj = t_store_oneProduct_prodsArrToAssociative(o), Array.prototype.forEach.call(e, (function(t) {
...
function t_store_oneProduct_successMsg_show(t, e, r) {
    if (!r.previewmode) {
        var o = document.getElementById("rec" + t),
            i = "RU" === window.tStoreBrowserLang ? "Товар успешно связан с каталогом. Название товара в каталоге: " : "Product is connected to catalog. Product name in catalog is ";
        ...
        if (s && a) {
            ...
            if (d) {
                ...
                if (c.value !== n) {
                    ...
                    })), d.classList.remove("t-product__option-item_active"), l.parentNode.classList.add("t-product__option-item_active"), setTimeout((function() {
                        t_store_unifyCardsHeights(t, r), r.verticalAlignButtons && t_store_verticalAlignButtons(t, r), t_store_triggerEvent(document.body, "twishlist_addbtn")
                    }), 50)
                }
            }
    ...
    Array.prototype.forEach.call(e.querySelectorAll(".js-product-edition-option-variants"), (function(t) {
        ...
        Array.prototype.forEach.call(o, (function(e) {
            e.addEventListener("change", (function() {
                var e = this.value;
                e = e.replace(/&/g, "&amp;"), s.value = e, t_triggerEvent(s, "change"), Array.prototype.forEach.call(i, (function(t) {
        ...
        var r = t.parentNode.querySelector(".t-product__option-variants_custom"),
            ...
            i = function t() {
                ...
                var i = this.closest(".t-product__option").querySelector(".t-product__option-selected.t-product__option-selected_color");
                if (i) {
                ...
                var n = this.closest(".t-product__option").querySelector(".t-product__option-selected.t-product__option-selected_image");
                if (n) {
                    var d = this.querySelector(".t-product__option-checkmark_image").style.backgroundImage,
                        ...
                        a;
                    (a = n.querySelector(".t-product__option-selected-checkmark")).setAttribute("data-original", c), a.style.backgroundImage = "none", a.style.backgroundImage = d
                }
            };
        Array.prototype.forEach.call(o, (function(t) {
        ...
        var s = function t(e) {
            var o = e.target,
                i;
            r.closest(".js-product-edition-option").contains(o) || r.classList.add("t-product__option-variants_hidden")
        };
...
function t_store_onFuncLoad(t, e, r) {
    if ("function" == typeof window[t]) e();
        ...
        setTimeout((function i() {
            var a = Date.now();
            "function" != typeof window[t] ? ("complete" === document.readyState && a - o > 7e3 && "function" != typeof window[t] && s(), setTimeout(i, r || 100)) : e()
        }))
    }
}
    ...
    for (var o in t)
        if (Object.prototype.hasOwnProperty.call(t, o)) {
            var i = e ? e + "[" + o + "]" : o,
                s = t[o],
                a;
            "{}" !== JSON.stringify(s) && null !== s && r.push(null !== s && "object" == typeof s ? t_store__serializeData(s, i) : encodeURIComponent(i) + "=" + encodeURIComponent(s))
        }
    return r.join("&")
}
...
function t_store_paramsToObj(t, e) {
    ...
    for (var n in a) {
        var d = a[n].sort,
            c = a[n].quantity;
        (d || c) && (o[n] && o[n].sort && e.previewmode || d && (o[n] || (o[n] = {}), o[n].sort = d), o[n] && o[n].quantity && "object" == typeof o[n].quantity && "y" === o[n].quantity[0] && e.previewmode || c && (o[n] || (o[n] = {}), o[t].quantity || (o[n].quantity = ["y"])))
    }
    ...
    if (r) {
        ...
        if (window.innerWidth > 960 && o && "none" === window.getComputedStyle(o).display && (o.style.display = ""), e.sidebar) {
            ...
            if (o) {
                ...
                window.innerWidth < 960 ? a && (t_store__removeElement(o), i.insertAdjacentElement("beforeend", o)) : a || (t_store__removeElement(o), s.insertAdjacentElement("afterbegin", o))
            }
        }
    }
}
...
function t_store_get_productCard_horizontalStructure(t, e, r, o, i, s) {
    var a = "";
    return (t.gallery[0] && "" !== t.gallery[0] || t.gallery[0] && "" !== t.gallery[0]) && r.prodCard && r.prodCard.hasImg && (a += '<div class="t-store__card__imgwrapper_column"' + (r.imageWidth && "0" !== r.imageWidth ? ' style="width: ' + r.imageWidth + 'px;"' : "") + ">" + o.open + t_store_get_productCard_img_html(t, r) + o.close + "</div>"), a += '<div class="t-store__card__contentwrapper">' + t_store_get_horizontalProductCard_txt_html(t, r, o, e, i, s) + t_store_get_horizontalProductCard_priceAndButtons(t, r, e, i, s) + "</div>"
}
...
function t_store_get_horizontalProductCard_txt_html(t, e, r, o) {
    ...
    if (t.title) var s = '<div class="t-store__card__title t-typography__title t-name t-name_md js-store-prod-name js-product-name"' + (Object.prototype.hasOwnProperty.call(e.typo, "title") ? ' data-auto-correct-font-size="rem" style="' + e.typo.title + '"' : "") + ">" + i + "</div>";
    var a = "";
    t.descr && e.prodCard && e.prodCard.hasDescr && (a = '<div class="t-store__card__descr t-typography__descr t-descr t-descr_xxs js-store-prod-descr"' + (Object.prototype.hasOwnProperty.call(e.typo, "descr") ? ' style="' + e.typo.descr + '"' : "") + ">" + t.descr + "</div>");
    var n = "",
        d;
    return o.sku && (n = '<div class="js-store-prod-sku js-product-sku" translate="no" style="display:none;">' + t.sku + "</div>"), '<div class="t-store__card__textwrapper">' + r.open + s + r.close + a + n + '<div class="js-product-controls-wrapper t-store__card__prod-controls-wrapper" style="display:none;"></div></div>'
}
...
function t_store_get_horizontalProductCard_priceAndButtons(t, e, r, o, i) {
    var s = parseInt(e.rightColumnWidth, 10),
        ...
        n;
    return '<div class="t-store__card__price-buttons' + (e.prodCard && "2" === e.prodCard.style ? " t-store__card__price-buttons_in-row" : "") + '"' + a + ">" + t_store_get_productCard_Price_html(t, r, e) + t_store_get_productCard_btn_html(t, e, o, i) + "</div>"
}
...
function t_store_triggerEvent(t, e, r) {
    ...
    r && window.CustomEvent ? (o = new CustomEvent(e, {
        ...
        bubbles: !0,
        cancelable: !1
    }), t.dispatchEvent(o)) : document.createEvent ? ((o = document.createEvent("HTMLEvents")).initEvent(e, !0, !1), o.eventName = e, t.dispatchEvent(o)) : document.createEventObject ? ((o = document.createEventObject()).eventType = e, o.eventName = e, t.fireEvent("on" + o.eventType, o)) : t[e] ? t[e]() : t["on" + e] && t["on" + e]()
}
...
function t_store__collectOptionsByElement(t) {
    ...
    Array.prototype.forEach.call(r, (function(t) {
        ...
        if (o) {
            ...
            if (s = parseFloat(s), r && i) {
                var a = {};
                "" != r && (r = t_store_escapeQuote(r)), "" != i && (i = (i = t_store_escapeQuote(i)).replace(/(?:\r\n|\r|\n)/g, "")), r.length > 1 && ":" == r.charAt(r.length - 1) && (r = r.substring(0, r.length - 1)), a.option = r, a.variant = i, a.price = s, e.push(a)
            }
        }
    }));
    ...
    return Array.prototype.forEach.call(i, (function(t) {
        ...
        Array.prototype.forEach.call(r, (function(r) {
            ...
            o && (o = t_store_escapeQuote(o)), o.length > 1 && ":" == o.charAt(o.length - 1) && (o = o.substring(0, o.length - 1));
            var i = r.name;
...
function t_store_fixedPopupButton(t) {
    ...
    if (s) {
        ...
        if (Array.prototype.forEach.call(a, (function(t) {
                t.classList.add(i)
            })), !(document.getElementById("allrecords") !== s.querySelector(".t-store__product-snippet") && document.getElementById("allrecords").contains(s.querySelector(".t-store__product-snippet")))) {
            ...
            window.isMobile && window.addEventListener("orientationchange", _), d.addEventListener(t_store_POPUP_SHOWED_EVENT_NAME, (function() {
                setTimeout((function() {
                    _()
                }), 0)
...
function t_store__loadCSSFile(t, e) {
    if (document.querySelector('link[href^="' + t + '"]')) e && e();
        ...
        r.rel = "stylesheet", r.type = "text/css", r.media = "all", r.href = t, e && (r.onload = e), r.onerror = function(t) {
...
t_onReady((function() {
        ...
        if (t) {
            ...
            r && (window.tStoreBrowserLang = r), (e = t.getAttribute("data-tilda-root-zone")) && (window.t_store_endpoint = "store.tildaapi." + e)
        }
